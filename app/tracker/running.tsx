...
const st = StyleSheet.create({
  ...
  doneTitle: { fontSize: 36, fontWeight: '800', color: '#111', lineHeight: 44, textAlign: 'center', marginTop: 4 },
  doneSub:   { fontSize: 14, color: '#777', textAlign: 'center', lineHeight: 22, marginTop: -4 },
  ...
  paceEvalTitle: { fontSize: 13, fontWeight: '700', marginBottom: 2 },
  paceEvalSub:   { fontSize: 11, color: '#666', lineHeight: 16 },
  ...
  paceRangeRow:   { gap: 2 },
  paceRangeLabel: { fontSize: 9, fontWeight: '700', color: '#888', letterSpacing: 0.8 },
  paceRangeValue: { fontSize: 13, fontWeight: '700' },
  paceStatusBadge:{
    paddingHorizontal: 10, paddingVertical: 4,
    borderRadius: 20,
  },
  paceStatusText: { fontSize: 10, fontWeight: '800', color: '#FFF', letterSpacing: 0.5 },
