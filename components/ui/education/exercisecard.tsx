...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '800', color: '#111', fontFamily: 'Lexend-Black' },
  subtitle: { marginTop: 4, fontSize: 13, color: '#777', fontFamily: 'Lexend-Regular' },
  description: { marginTop: 16, fontSize: 14, lineHeight: 22, color: '#666', fontFamily: 'Lexend-Regular' },
  ...
  infoText: { fontSize: 12, fontWeight: '600', color: '#555', fontFamily: 'Lexend-Bold' },
  footer: {
    marginTop: 18, paddingTop: 16,
    borderTopWidth: 1, borderTopColor: '#EAEAEA',
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
  },
  footerText: { fontSize: 14, fontWeight: '700', color: '#111', fontFamily: 'Lexend-Bold' },
});